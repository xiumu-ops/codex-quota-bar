...
namespace CodexQuotaBar {
    ...
    constexpr UINT WM_CQB_STATS = WM_APP + 3;        // lParam=unique_ptr<TokenStats>
    constexpr UINT WM_CQB_SHOW = WM_APP + 4;
    constexpr UINT WM_CQB_HIDE = WM_APP + 5;
    constexpr UINT WM_CQB_TOGGLE = WM_APP + 6;
    constexpr UINT WM_CQB_QUOTA_RESULT = WM_APP + 7; // lParam=unique_ptr<QuotaSnapshot>
    ...
    private:
        ...
        std::shared_ptr<std::atomic<bool>> m_cancelFetch = std::make_shared<std::atomic<bool>>(false);
