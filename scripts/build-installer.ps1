...
$SetupPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.6.1.exe"
$HashPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.6.1.sha256"

Write-Host "Building Codex-Quota-Bar 2.6.1 application..." -ForegroundColor Cyan
...
Set-Content -LiteralPath $HashPath `
    -Value "$hash  Codex-Quota-Bar_version_2.6.1.exe" -Encoding ascii

$allowedReleaseFiles = @(
    "Codex-Quota-Bar_version_2.6.1.exe",
    "Codex-Quota-Bar_version_2.6.1.sha256"
)
