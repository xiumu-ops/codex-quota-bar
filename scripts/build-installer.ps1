...
$SetupPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.2.exe"
$HashPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.2.sha256"

Write-Host "Building Codex-Quota-Bar 2.7.2 application..." -ForegroundColor Cyan
...
Set-Content -LiteralPath $HashPath `
    -Value "$hash  Codex-Quota-Bar_version_2.7.2.exe" -Encoding ascii

$allowedReleaseFiles = @(
    "Codex-Quota-Bar_version_2.7.2.exe",
    "Codex-Quota-Bar_version_2.7.2.sha256"
)
