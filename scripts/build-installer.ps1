...
$SetupPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.3.exe"
$HashPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.3.sha256"

Write-Host "Building Codex-Quota-Bar 2.7.3 application..." -ForegroundColor Cyan
...
Set-Content -LiteralPath $HashPath `
    -Value "$hash  Codex-Quota-Bar_version_2.7.3.exe" -Encoding ascii

$allowedReleaseFiles = @(
    "Codex-Quota-Bar_version_2.7.3.exe",
    "Codex-Quota-Bar_version_2.7.3.sha256"
)
