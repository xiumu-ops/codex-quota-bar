...
$SetupPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.6.exe"
$HashPath = Join-Path $ReleaseDir "Codex-Quota-Bar_version_2.7.6.sha256"

Write-Host "Building Codex-Quota-Bar 2.7.6 application..." -ForegroundColor Cyan
...
Set-Content -LiteralPath $HashPath `
    -Value "$hash  Codex-Quota-Bar_version_2.7.6.exe" -Encoding ascii

$allowedReleaseFiles = @(
    "Codex-Quota-Bar_version_2.7.6.exe",
    "Codex-Quota-Bar_version_2.7.6.sha256"
)
